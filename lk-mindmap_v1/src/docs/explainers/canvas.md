...
The canvas is the main workspace — an infinite surface where your board lives.

## Move around

**Space + drag** pans across the board. **Scroll** (trackpad or mouse wheel) zooms in and out. You can also use the zoom controls in the footer.
