...
6. Watch the top bar: after a moment it should read **All changes saved**.
7. Optional — click the disk icon or choose **Save** from the **⋯** menu to save immediately.

Your board file appears in the library sidebar and in your boards folder as a `.lkmindmap` file.
